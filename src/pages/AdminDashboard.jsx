      ...
      <table width="520" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr><td style="padding:40px;">
          ...
          <div style="background:#F0EDE8;border:1px solid #E4E1DC;border-radius:8px;padding:16px 20px;margin-bottom:16px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="vertical-align:top;width:22px;padding-top:2px;"><span style="display:inline-block;width:7px;height:7px;border-radius:50%;background:#C8A96E;margin-top:5px;"></span></td>
                <td style="font-size:13px;color:#141210;line-height:1.6;padding-bottom:8px;"><strong>E-mail + wachtwoord:</strong> gebruik het e-mailadres en tijdelijk wachtwoord hieronder.</td>
              </tr>
              <tr>
                <td style="vertical-align:top;padding-top:2px;"><span style="display:inline-block;width:7px;height:7px;border-radius:50%;background:#C8A96E;margin-top:5px;"></span></td>
                <td style="font-size:13px;color:#141210;line-height:1.6;"><strong>Single Sign-On (SSO):</strong> log in met je bestaande Google- of Microsoft-account via de knop op de loginpagina — geen apart wachtwoord nodig.</td>
              </tr>
            </table>
          </div>
